        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 md:mb-8">
            <div className="flex items-center gap-3 md:gap-4">
                <div className="relative">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-primary p-[2px] shadow-lg shadow-primary/20">
                ...
                <div>
                    <h2 className="text-base md:text-lg font-bold text-foreground leading-tight">Welcome back, Student! 👋</h2>
            ...
            <div className="flex items-center gap-2 md:gap-3 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
                ...
                <div className="flex items-center gap-3 bg-primary/10 border border-primary/20 px-4 py-2 md:px-5 md:py-2.5 rounded-xl cursor-pointer hover:bg-primary/20 transition-all w-full md:w-auto justify-between md:justify-start shadow-sm">
