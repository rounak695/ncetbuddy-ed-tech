    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <div className="max-w-4xl mx-auto py-16 px-6">
                {/* Page Title */}
                <div className="mb-12">
                    <h1 className="text-4xl font-black text-black uppercase mb-2">Privacy Policy</h1>
                ...
                <div className="space-y-8 text-black text-sm leading-relaxed">
                    <section>
                        <h2 className="text-lg font-bold uppercase mb-3">Introduction</h2>
                        <p className="mb-3">
                            This Privacy Policy describes how <strong>ExamBuddy</strong> and its affiliates (collectively "ExamBuddy, we, our, us") collect, use, share, protect or otherwise process your information/ personal data through our website <strong>www.ncetbuddy.in</strong> (hereinafter referred to as Platform). Please note that you may be able to browse certain sections of the Platform without registering with us.
                        </p>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg font-bold uppercase mb-3">Collection</h2>
                        <p className="mb-3">
                    ...
                    <section>
                        <h2 className="text-lg font-bold uppercase mb-3">Usage</h2>
                        <p className="mb-3">
                    ...
                    <section>
                        <h2 className="text-lg font-bold uppercase mb-3">Sharing</h2>
                        <p className="mb-3">
                    ...
                    <section>
                        <h2 className="text-lg font-bold uppercase mb-3">Security Precautions</h2>
                        <p className="mb-3">
                    ...
                    <section>
                        <h2 className="text-lg font-bold uppercase mb-3">Data Deletion and Retention</h2>
                        <p className="mb-3">
                    ...
                    <section>
                        <h2 className="text-lg font-bold uppercase mb-3">Your Rights</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg font-bold uppercase mb-3">Consent</h2>
                        <p className="mb-3">
                        ...
                        <p className="mb-3">
                            You have an option to withdraw your consent that you have already provided by writing to the Grievance Officer at the contact information provided below. Please mention <strong>"Withdrawal of consent for processing personal data"</strong> in your subject line of your communication.
                        </p>
                        <p className="mb-3">
                    ...
                    <section>
                        <h2 className="text-lg font-bold uppercase mb-3">Changes to this Privacy Policy</h2>
                        <p>
