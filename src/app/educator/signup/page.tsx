            ...
            <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-12 lg:gap-24 items-start">
                ...
                <div className="flex flex-col gap-8 text-black pb-12 pt-6">
                    <div className="space-y-4">
                        <h1 className="text-4xl md:text-6xl font-black uppercase italic tracking-tighter leading-[0.9]">
                            Create your <span className="bg-primary px-1">teaching empire</span> with confidence.
                        </h1>
                        <h2 className="text-xl md:text-2xl font-bold opacity-70">
                            Powerful exam platform. Zero infrastructure headaches.
                        </h2>
                    </div>

                    <div className="space-y-6 text-lg font-medium opacity-80 leading-relaxed max-w-2xl">
                        <p>
                            Join thousands of educators who trust our platform to deliver secure, scalable testing.
                            Focus on <span className="font-bold text-black border-b-2 border-primary">teaching and growing</span> your business—we handle the rest.
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-2xl border-2 border-black flex flex-col gap-6">
                    <div className="flex flex-col gap-2">
                        <h3 className="text-3xl font-black uppercase tracking-tight text-black">Create Account</h3>
                        <p className="text-lg font-medium text-foreground opacity-70">Sign up with Google to get started</p>
                    </div>
                    ...
                    <p className="text-foreground/60 text-sm text-center mt-2">
                        Already have an account? <Link href="/educator/login" className="text-primary hover:underline font-bold">Sign in</Link>
                    </p>
                </div>
            </div>
        </div>
